...
local function YKPMESF_fake_script() -- EternalXMain.Smooth GUI Dragging 
...
coroutine.wrap(YKPMESF_fake_script)()
local function NKAPHIZ_fake_script() -- GameTitle.LocalScript 
...
coroutine.wrap(NKAPHIZ_fake_script)()
local function DVMXQN_fake_script() -- ImageLabel.LocalScript 
...
coroutine.wrap(DVMXQN_fake_script)()
local function GTZO_fake_script() -- TextLabel.LocalScript 
	local script = Instance.new('LocalScript', TextLabel)

	script.Parent.Text = "" ..game.Players.LocalPlayer.DisplayName
end
coroutine.wrap(GTZO_fake_script)()
local function LCIWTCY_fake_script() -- TextLabel_2.LocalScript 
...
coroutine.wrap(LCIWTCY_fake_script)()
local function DVKOO_fake_script() -- settings.LocalScript 
...
coroutine.wrap(DVKOO_fake_script)()
