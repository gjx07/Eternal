...
local function UEIP_fake_script() -- EternalXMain.Smooth GUI Dragging 
...
coroutine.wrap(UEIP_fake_script)()
local function VZRX_fake_script() -- GameTitle.LocalScript 
...
coroutine.wrap(VZRX_fake_script)()
local function TALQ_fake_script() -- ImageLabel.LocalScript 
...
coroutine.wrap(TALQ_fake_script)()
local function QMUW_fake_script() -- TextLabel.LocalScript 
	local script = Instance.new('LocalScript', TextLabel)

	script.Parent.Text = "" ..game.Players.LocalPlayer.DisplayName
end
coroutine.wrap(QMUW_fake_script)()
local function UAID_fake_script() -- TextLabel_2.LocalScript 
...
coroutine.wrap(UAID_fake_script)()
local function DANEMN_fake_script() -- settings.LocalScript 
...
coroutine.wrap(DANEMN_fake_script)()


local TabHolder = {}

function TabHolder:CreateTabButton(TabText)
