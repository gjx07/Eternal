...
function EternalLib:CreateWindow(TitleText)
    ...
    local function AQXCEK_fake_script() -- EternalXMain.Smooth GUI Dragging 
    ...
    coroutine.wrap(AQXCEK_fake_script)()
    local function ETUDI_fake_script() -- GameTitle.LocalScript 
    ...
    coroutine.wrap(ETUDI_fake_script)()
    local function HFAP_fake_script() -- ImageLabel.LocalScript 
    ...
    coroutine.wrap(HFAP_fake_script)()
    local function WGQP_fake_script() -- TextLabel.LocalScript 
        local script = Instance.new('LocalScript', TextLabel)
    
        script.Parent.Text = "" ..game.Players.LocalPlayer.DisplayName
    end
    coroutine.wrap(WGQP_fake_script)()
    local function FGWYIY_fake_script() -- TextLabel_2.LocalScript 
    ...
    coroutine.wrap(FGWYIY_fake_script)()
    local function ELRWI_fake_script() -- settings.LocalScript 
